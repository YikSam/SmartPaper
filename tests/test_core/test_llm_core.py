...
from SmartPaper.core.llm_core import (
    get_llm_response,
...
if __name__ == "__main__":
    ...
    print("\n\n流式回调示例:")
    get_llm_response_with_callback(
        "请简要介绍Transformer模型架构", callback=print_callback, model="Qwen/Qwen3-8B"
    )
    ...
    messages = [
        ...
        {
            "role": "assistant",
            "content": "大语言模型（Large Language Model，简称LLM）是一类基于深度学习的自然语言处理模型，通过在大规模文本语料库上训练，能够理解和生成人类语言。",
        },
    ...
    get_llm_response_with_history_callback(
        messages, callback=history_callback, model="Qwen/Qwen3-8B"
    )
