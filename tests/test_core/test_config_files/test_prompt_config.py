...
class TestPromptConfig:
    ...
    def test_get_prompt_description(self, real_prompts_dir):
        ...
        # 测试默认值
        description = config.get_prompt_description(
            "llm", "non_existent", default="default description"
        )
    ...
    def test_set_prompt_with_auto_save(self, temp_prompts_dir):
        ...
        result = config.set_prompt(
            "llm", "auto_save_prompt", "Auto save template", "Auto save description", auto_save=True
        )
        assert result is True
