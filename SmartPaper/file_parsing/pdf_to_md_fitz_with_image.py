...
def advanced_image_handler(
    page: pm.Page,
    page_num: int,
    output_dir: str,
    api_key: Optional[str] = None,
    delete_rendered_image: bool = True,
...
def extract_pdf_content(
    ...
    image_handler: Optional[
        Callable[[pm.Page, int, str, Optional[str], bool, bool, Optional[str]], str]
    ] = None,
    api_key: Optional[str] = None,
