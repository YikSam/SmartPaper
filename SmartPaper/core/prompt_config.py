"""
提示词配置类
用于从prompts目录下的YAML文件加载提示词，并支持热加载和管理提示词
"""
...
class PromptConfig:
    ...
    def __init__(self, prompts_dir=None):
        ...
        self.prompts = {"llm": {}, "llm_with_image": {}}
    ...
    def get_prompt_description(
        self, prompt_type: str, prompt_name: str, default: str = None
    ) -> str:
        """
        获取指定类型和名称的提示词描述
    ...
    def list_prompts(self, prompt_type: str = None) -> Dict[str, List[str]]:
        ...
        if prompt_type is None:
            ...
            for pt in self.prompts:
                result[pt] = self.prompts[pt]
        elif prompt_type in self.prompts:
            # 返回指定类型的提示词
            result[prompt_type] = self.prompts[prompt_type]
